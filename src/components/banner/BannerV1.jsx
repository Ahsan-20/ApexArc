                        ...
                        <div className="content">
                            <div className="row align-center">
                                <div className="col-xl-6 col-lg-6">
                                    <div className="information">
                                        <ReactWOW delay="500ms" duration="400ms">
                                            <h2 className="fadeInUp">Innovative <strong>Solutions</strong></h2>
                                        </ReactWOW>
                                        <ReactWOW delay="900ms" duration="400ms">
                                            <p className="fadeInUp">
                                            At APEXARC, we deliver innovative solutions in web and app development, AI, UI/UX design, generative AI, and chatbots, turning your ideas into reality with precision and creativity
                                            </p>
                                        </ReactWOW>
                                ...
                                <div className="col-xl-6 col-lg-6 pl-50 pl-md-15 pl-xs-15">
                                    <div className="thumb">
                                        <ReactWOW>
                                            <img className="fadeInUp" src="img/thumb/ai1.jpg" alt="Banner Image" />
                                        </ReactWOW>
                                        <ReactWOW delay="500ms">
                                            <img className="fadeInDown" src="img/thumb/wc.png" alt="Banner Image" />
                                        </ReactWOW>
                                    </div>
                                </div>
                            </div>
