                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xl-6 col-lg-5">
                            ...
                            <h2 className="title mb-30">Full range of <br /> technology and consulting services!</h2>
                            <p>
                                We provide comprehensive solutions tailored to your business needs, from app deployment to IT consulting. Our expertise helps you innovate and grow efficiently in the digital landscape.
                            </p>
